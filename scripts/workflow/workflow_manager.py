...
class WorkflowManager:
    ...
    def run_workflow(self):
        datagouv = DataGouvSearcher(self.config)
        single_urls = SingleUrlsBuilder(self.config)
        
        datagouv_subventions_files_in_scope = datagouv.get_datafiles(self.config["search"]["subventions"])

        single_urls_subventions_files_in_scope = single_urls.get_datafiles(self.config["search"]["subventions"])
        ...
        subventions_datafiles = DatafilesLoader(subventions_files_in_scope,self.config)
        ...
        marches_publics = DatafileLoader(self.config)
